    ...
    <div className="border rounded-md overflow-hidden shadow-sm">
      ...
      <div className="grid grid-cols-8 border-b bg-muted/20">
        ...
        {visibleDates.map((date, index) => (
          ...
          >
            <div className="text-sm md:text-base">{['Sun', 'Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat'][date.getDay()]}</div>
            <div className={cn(
              "text-sm mx-auto flex items-center justify-center w-7 h-7 rounded-full transition-colors", 
      ...
      <div className="grid grid-cols-1 divide-y">
        {visibleHours.map(hour => (
          <div key={hour} className="grid grid-cols-8">
            {/* Time column */}
            <div className="p-2 text-xs text-center border-r text-muted-foreground bg-muted/5">
