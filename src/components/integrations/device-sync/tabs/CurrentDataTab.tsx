    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
      {healthData.steps && (
        <HealthMetric
          ...
          icon={getMetricIcon('steps') as React.FC<any>}
      ...
      {healthData.heartRate && (
        <HealthMetric
          ...
          icon={getMetricIcon('heart rate') as React.FC<any>}
      ...
      {healthData.calories && (
        <HealthMetric
          ...
          icon={getMetricIcon('calories') as React.FC<any>}
      ...
      {healthData.distance && (
        <HealthMetric
          ...
          icon={getMetricIcon('distance') as React.FC<any>}
      ...
      {healthData.sleep && (
        <HealthMetric
          ...
          icon={getMetricIcon('sleep') as React.FC<any>}
      ...
      {healthData.activeMinutes && (
        <HealthMetric
          ...
          icon={getMetricIcon('active minutes') as React.FC<any>}
