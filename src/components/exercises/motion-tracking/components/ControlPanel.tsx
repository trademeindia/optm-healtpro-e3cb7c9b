    ...
    <Card className="border border-border/60 shadow-sm">
      <CardContent className="p-4 flex flex-col sm:flex-row gap-3 justify-between items-center">
        ...
        <Button
          ...
          variant="outline"
          className="w-full sm:w-auto flex items-center justify-center gap-2 border-primary/30"
          size="lg"
        >
        ...
        {!isModelLoaded && (
          <div className="text-sm text-amber-600 dark:text-amber-400 animate-pulse flex items-center">
