        ...
        <main className="flex-1 overflow-y-auto p-4 md:p-6 bg-gray-50 dark:bg-gray-900">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="mt-6 bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden">
              <Tabs orientation="vertical" defaultValue="overview" value={activeTab} onValueChange={setActiveTab} className="w-full flex">
                
                
                <div className="flex-1 p-6 overflow-auto">
                  <TabsContent value="overview" className="mt-0 h-full">
                    <OverviewTabContent dashboardData={dashboardData} currentDate={currentDate} handleViewPatient={handleViewPatient} handleSaveReport={handleSaveReport} filterPeriod={filterPeriod} setFilterPeriod={setFilterPeriod} />
                  </TabsContent>
                  
                  <TabsContent value="appointments" className="mt-0 h-full">
                    <AppointmentsTabContent appointments={dashboardData.upcomingAppointments || []} currentDate={currentDate} setCurrentDate={setCurrentDate} />
                  </TabsContent>
                  
                  <TabsContent value="reports" className="mt-0 h-full">
                    <MedicalReportsTabContent reports={dashboardData.clinicDocuments || []} onUpload={() => setShowUploadDialog(true)} />
                  </TabsContent>
                  
                  <TabsContent value="history" className="mt-0 h-full">
                    <MedicalHistoryTabContent patients={dashboardData.patients || []} selectedPatient={selectedPatient} onViewPatient={handleViewPatient} onClosePatientHistory={handleClosePatientHistory} />
                  </TabsContent>
