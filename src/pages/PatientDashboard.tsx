      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <main className="flex-1 overflow-y-auto p-0">
          <div className="container mx-auto p-4 md:p-6 max-w-7xl">
            <h1 className="text-2xl font-bold mb-6 text-gray-900 dark:text-white">Patient Dashboard</h1>
            
            <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
              {/* Left Column (3 columns on md screens) */}
              <div className="md:col-span-3 space-y-6">
                <LeftColumn />
                <RecentAnatomyActivity />
              </div>
              
              {/* Main Content (6 columns on md screens) */}
              <div className="md:col-span-6 bg-white dark:bg-gray-800 rounded-lg shadow p-4">
